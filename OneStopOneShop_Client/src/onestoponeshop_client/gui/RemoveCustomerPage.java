...
/*
 * RemoveCustomerPage.java
 *
 * Created on Sep 20, 2011, 11:48:28 PM
 */
 ...
 * @author Gaiz
 */
public class RemoveCustomerPage extends javax.swing.JPanel {
    private Customers customer;

    /** Creates new form RemoveCustomerPage */
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "Remove Customer", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.ABOVE_TOP, new java.awt.Font("Calibri", 1, 18))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            CustomerHandler.getCustomerhandler().removeCustomer(Integer.parseInt(jTextField1.getText()));
        }catch(NumberFormatException ex){
            JOptionPane.showMessageDialog(null, "Please enter a numeric ID to remove.", "Error", 0);
        }
